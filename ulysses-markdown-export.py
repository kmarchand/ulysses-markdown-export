...
udir = '/Users/username/Desktop/ulysses-sheets' # specify folder containing copied Ulysses pages here
outdir = '/Users/username/Desktop/output-directory' # specify output folder here (with no trailing "/")
